...
for p=0:h:t
    ...
    for M=1:6
                ...
                if M==3
                    u_1=x1(A,1)-x1(A,3)+x1(A,5)-x1(A,3)+x1(A,6)-x1(A,3)-v1(A,1);
                    U1=[U1 u_1];
                    u_2=x1(A,7)-x1(A,9)+x1(A,11)-x1(A,9)+x1(A,12)-x1(A,9)-v1(A,5);
                    U2=[U2 u_2];
                end    
                if M==4
                    u_1=x1(A,5)-x1(A,4)+x1(A,6)-x1(A,4)-v1(A,2);
                    U1=[U1 u_1];
                    u_2=x1(A,11)-x1(A,10)+x1(A,12)-x1(A,10)-v1(A,6);
                    U2=[U2 u_2];
                end  
                if M==5
                    ...
                    V5=inv(M5)*([x1(A,2)-x1(A,5)+x1(A,3)-x1(A,5)+x1(A,4)-x1(A,5)-v1(A,3);x1(A,8)-x1(A,11)+x1(A,9)-x1(A,11)+x1(A,10)-x1(A,11)-v1(A,7)]-C5*[v1(A,3);v1(A,7)]);
                    u_1=V5(1);
                    U1=[U1 u_1];
                    u_2=V5(2); 
                    U2=[U2 u_2];
